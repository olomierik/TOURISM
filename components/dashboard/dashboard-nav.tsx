...
import { BarChart3, ConciergeBell, CreditCard, Images, Inbox, LayoutDashboard, Package, Store, Tag, Wallet } from 'lucide-react';
...
const ITEMS = [
  ...
  { href: '/dashboard/payments', key: 'paymentsNav', Icon: Wallet },
